...
class EcoFlowApiClient:
    ...
    def map_data_to_api_response(cls, raw_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            "powGetAcIn": cls._as_positive_number(raw_data.get("powGetAcIn")),
            "batteryperc": float(raw_data.get("cmsBattSoc") or 0),
            "poweroutsum": cls._as_positive_number(raw_data.get("powOutSumW")),
            "poweroutAc1": cls._as_positive_number(item1),
            "poweroutAc2": cls._as_positive_number(item3),
            "powInSumW": cls._as_positive_number(raw_data.get("powInSumW")),
            ...
            "powGetTypec3": cls._as_positive_number(raw_data.get("powGetTypec3")),
            "powGetTypec1": cls._as_positive_number(raw_data.get("powGetTypec1")),
            "powGetTypec2": cls._as_positive_number(raw_data.get("powGetTypec2")),
